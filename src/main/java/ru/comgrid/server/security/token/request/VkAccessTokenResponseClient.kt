...
import ru.comgrid.server.security.token.converter.VkAccessTokenRequestConverter
import ru.comgrid.server.security.token.converter.VkAccessTokenResponseConverter

private const val INVALID_TOKEN_RESPONSE_ERROR_CODE = "invalid_token_response"

@Service
class VkAccessTokenResponseClient : OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest> {
