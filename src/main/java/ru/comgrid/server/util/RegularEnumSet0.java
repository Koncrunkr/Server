 ...
 * @serial exclude
 */
public class RegularEnumSet0<E extends Enum<E>> extends EnumSet0<E>{
    /**
    ...
    public RegularEnumSet0(Class<E>elementType, Enum<?>[] universe, long elements){
        super(elementType, universe);
        this.elements = elements;
    }

    RegularEnumSet0(Class<E>elementType, Enum<?>[] universe) {
        super(elementType, universe);
    }
    ...
    public boolean containsAll(Collection<?> c) {
        if (!(c instanceof RegularEnumSet0<?>))
            return super.containsAll(c);

        var es = (RegularEnumSet0<?>) c;
    ...
    public boolean retainAll(Collection<?> c) {
        ...
        RegularEnumSet0<?> es = (RegularEnumSet0<?>) c;
    ...
    public boolean equals(Object o) {
        if (!(o instanceof RegularEnumSet0<?>))
            return super.equals(o);

        var es = (RegularEnumSet0<?>) o;
